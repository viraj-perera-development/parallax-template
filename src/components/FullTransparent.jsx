...
function FulltransparentSection({orientation, background, text, button, href, title, description, image, backgroundColor, bgOpacity}) {
          ...
          {orientation === 'left' ? (
            ...
            <div className={`relative z-20 h-dvh overflow-hidden flex justify-center items-center ${backgroundColor}`}>
                <div className={`w-full h-full grid grid-cols-1 lg:grid-cols-2`}>
                    ...
                    <div className="flex flex-col justify-center items-start px-4 md:px-8 lg:px-12 text-left">
                        <h2 className={`text-4xl lg:text-7xl ${text} font-semibold`} data-aos="fade-up" data-aos-duration="1000">{title}</h2>
                        <div className={`text-lg lg:text-xl mt-4 mb-10 ${text}`} data-aos="fade-up" data-aos-duration="1000" dangerouslySetInnerHTML={createMarkup(description)}></div>
