  ...
  return (
    ...
    <div className='relative z-20 h-dvh overflow-hidden'>
        <MouseParallax enableOnTouchDevice={true} isAbsolutelyPositioned={true} strength="0.05">
            <video className="absolute top-0 left-0 w-full h-full object-cover" style={{ transform: 'scale(1.5)' }} autoPlay muted playsInline loop>
        ...
        <div className="absolute top-0 left-0 bg-black bg-opacity-20 w-full h-full">
            ...
            <SlArrowDown 
                ...
                className='cursor-pointer hidden md:block absolute bottom-10 left-1/2 transform -translate-x-1/2 text-slate-50 text-7xl' />
        </div>
    </div>
